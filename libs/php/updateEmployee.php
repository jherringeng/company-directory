<?php
	...
	$query = "UPDATE personnel SET lastName='" . $_REQUEST['lastName'] ."', firstName='" . $_REQUEST['firstName'] . "', jobTitle='" . $_REQUEST['jobTitle'] . "', email='" . $_REQUEST['email'] . "', departmentID='" . $_REQUEST['department'] . "' WHERE id=" . $_REQUEST['id']; // ' . $_REQUEST['id'] . '
