<?php
	...
	$query = "UPDATE personnel SET lastName='$lastName', firstName='$firstName', jobTitle='Awesome', email='aa@abc.com', departmentID='$departmentID', jobTier = '$jobTier' WHERE id='$id'";
